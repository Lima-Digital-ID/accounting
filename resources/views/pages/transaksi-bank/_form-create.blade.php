<form action="{{ route('bank-transaksi.store') }}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            ...
            <select name="tipe" id="tipe" class="select2 form-control  js-example-basic-single @error('tipe') is-invalid @enderror">
        ...
        <div class="col-sm-4 ">
            ...
            <select name="kode_akun" id="kode_akun" class="select2 form-control js-example-basic-single @error('kode_akun') is-invalid @enderror">
